...
class StateSensusAnalyserTest {
    ...
    private static final String WRONG_INDIA_CENSUS_FILE_TYPE = "./src/main/resources/IndiaStateCensusData.py";
    ...
    @Test
    public void givenWrongStateCsvFiletPEShouldReturnException() {
        try {
            stateCensusAnalyser.loadCensusData(WRONG_INDIA_CENSUS_FILE_PATH);
        } catch (StateCensusAnalyserException e) {
